...
(async () => {
  ...
  // ## xlsx
  // team1
  const teamsWorkbook1 = xlsx.readFile('./importFile/installation/prod-2020-01-07/20210107-Zone.xls');
  ...
  // team2
  const teamsWorkbook2 = xlsx.readFile('./importFile/installation/prod-2020-01-07/20210107-Subcontractor.xls');
  ...
  // user
  const userWorkbook = xlsx.readFile('./importFile/installation/prod-2020-01-07/20210107-Staff_Info.xls');
